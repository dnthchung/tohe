...
export function Chapter3Page() {
  ...
  const renderChunk = useCallback(
    (chunkData: (typeof chunkPositions)[0]) => {
      ...
      return (
        <div key={chunkData.id} data-chunk-id={chunkData.id} className="absolute w-full flex items-center justify-center overflow-hidden" style={{ top: chunkData.top, height: chunkData.height + 2 }}>
          <img
            src={nenHong2}
            className="absolute top-0 left-0 w-full z-0"
            alt="Background"
